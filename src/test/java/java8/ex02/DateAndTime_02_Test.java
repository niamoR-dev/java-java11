...
public class DateAndTime_02_Test {
	...
	public void test_localDate_format_with_hour() {
		...
		localDate.format(DateTimeFormatter.ofPattern("dd/MM/yyyy dd:mm:ss"));
	...
	public void test_with() {
		...
		LocalDate result = localDate.withYear(2015).withMonth(02).with(ChronoField.DAY_OF_MONTH, 05);
